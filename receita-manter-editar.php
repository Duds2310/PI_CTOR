...
$categoria = $repoCategoriaReceita->
...
<div class="container">
	<div class="card mb-3">
		...
		<div class="card-body">
			<form action="receita-manter-editar-action.php?id=<?php echo $idReceita; ?>" method="post">
				
				<input type="hidden" value="<?php echo $receita[0]->getId();?>" name="id">
				<div class="form-group form-row">
					<div class="col-md-2">
						<label>Data de cadastro </label>
						<input type="date" name="dataCadastro" value="<?php echo $receita[0]->getDataCadastro() ?>" id="dataCadastro" class="form-control" placeholder="Data de Cadastro">
					</div>
					<div class="col-md-2">
						<label>Data de pagamento </label>
						<input type="date" name="dataPagamento" value="<?php echo $receita[0]->getDataPagamento() ?>" id="dataPagamento" class="form-control" placeholder="Data de Pagamento">
					</div>
					<div class="col-md-8">
						<label>&nbsp; </label>
						<input type="text" name="autor" value="<?php echo $receita[0]->getIdUsuario() ?>" id="autor" class="form-control" placeholder="Autor">
					</div>
				</div>
				<div class="form-group form-row">
					<div class="col-md-12">
				...
				<div class="form-group form-row">
					<div class="col-md-6">
						<select class="form-control form-control-sm" name="categoria">
							<option value="<?php echo $receita[0]->getId(); ?>"> <!-- PAREI AQUI, Falta consultar a categoria da receita propria, Falta o repositorio De categorias (JUNIOR) --></option> 
				...
				<div class="form-group form-row">
					<div class="col-md-6">
                    	...
                    	<option
								value="<?php echo $listaUsuario[$i]->getId();?>">
                    	<?php
