...
/**
 * Classe responsavel por realizar a conex�o com o banco de dados
 * e manter as informa��es do treinamento: inserindo, alterando, consultando e excluindo
 * os dados da tabela.
 * Outra nomenclatura para essas classes s�o 'DAO'.
 *
 * @author Milton
 *        
 */
...
//        $i = 0;
    ...
    public function alterarTreinamento($Treinamento)
    {
        ...
        $query = " UPDATE TB_TREINO SET TRE_DATA = '" . $Treinamento->getData() . "', TRE_DESCRICAO =  '" . $Treinamento->getDescricao() ."',
         TRE_CATEGORIA = '" . $Treinamento->getCategoria() . "', TRE_SITUACAO = '" . $Treinamento->getSituacao() . "' WHERE TRE_ID = " . $Treinamento->getId();
