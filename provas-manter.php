...
?>
    ...
    <div class="card mb-3">
    	...
    	<div class="card-body">
    		<form action="provas-manter-cadastrar-action.php" method="post">
    			<div class="form-group form-row">
    				<div class="col-md-6">
    					<label> Nome: </label>
    					<input type="text" name="nome" id="nome" class="form-control" placeholder="Digite o nome da prova...">
    				
    				</div>
    				<div class="col-md-6">
    					<label> Tipo: </label>
    					<select name="tipo" id="tipo" class="form-control" placeholder="Informe o Tipo de Prova">
				...
				<div class="form-group form-row">
    				<div class="col-md-6">
    					...
    					<select name="uf" id="uf" class="form-control" placeholder="Uf">
                                <option value="vazio"> -- Selecione -- </option>
    			...
    			<div class="form-group form-row">
    				<div class="col-md-2">
    					...
    					<input type="date" name="dataInicio" id="dataInicio" class="form-control" placeholder="Preencha a Data de Inicio">
    				</div>
	 				<div class="col-md-2">
    					<label> Data do Fim: </label>
    					<input type="date" name="dataFim" id="dataFim" class="form-control" placeholder="Preencha a Data do Fim">
    				</div>
	    		</div>
    			...
    			<table class="table table-bordered" id="MyTableID" width="100%"
    				...
    				<?php while($i < $quantidade) { ?>
    					<tr>
    						...
    						<td><a
    							href="provas-manter-editar.php?id=<?php echo $ListaProvas[$i]->getID(); ?>"><i
    								class="fa fa-edit"></i></a> |<a
    							href="provas-manter-deletar-action.php?id=<?php echo $ListaProvas[$i]->getID(); ?>">
