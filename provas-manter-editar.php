...
<div class="container">
	<div class="card mb-3">
		...
		<div class="card-body">
			<form action="provas-manter-editar-action.php?id=<?php echo $idProvas; ?>" method="post">
					...
					<div class="form-row">
						...
						<label>Nome: </label>
							<div class="form-label-group">
								...
								<input type="text" name="nome" id="nome" value="<?php echo $provas[0]->getNome();?>" class="form-control"
									 required="required" 
									autofocus="autofocus">
							</div>
						</div>
				...
				<label>Federação: </label>
					<div class="form-row">
						<div class="col-md-6">
							<div class="form-label-group">								 
								<input type="text" name="federacao" id="federacao" value="<?php echo $provas[0]->getFederacao();?>" class="form-control"
									placeholder="Informe a Federacao" required="required">
							</div>
						</div>
					</div>
				</div>
